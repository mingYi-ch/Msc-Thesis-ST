...
res.dir <- get.res.dir()
res.dir
deconProp <- qread("/data/myi/mt-spatial-transcriptomics/results/deconvolution/ deconProp_best.qs")
```
...
```{r}
spe$dist.cluster <- bin.dists2(spe$min.dists, label_fmt = "%.3f")
...
qs::qsave(spe, file.path(res.dir, "se_dist.qs"))
```
