...
# expression_data <- qread(file.path(res.dir, glue("expression_data_nei_{num_genes}_{nei.spots}_log.qs")))
# boot.res <- qread(file.path(res.dir, glue("boot_res_nei_{num_genes}_{nei.spots}_log.qs")))
# info <- boot.res[[1]]
```
