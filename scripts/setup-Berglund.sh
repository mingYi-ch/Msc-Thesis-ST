...
/data/myi/.local/bin/std --file ~/data/mt-spatial-transcriptomics/data/processed/sp_counts_SHK166_RA_Knee.tsv --iter 2000  --types 7  --output results/Berglund_Result/
